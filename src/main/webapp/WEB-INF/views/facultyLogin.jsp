...
<html lang="en">
  ...
  <!-- navbar -->
  	...
  	<section>
  		...
  		<div id="login">
        <h3 class="text-center text-white pt-5">Faculty Login</h3>
        <div class="container">
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="facultyValidation" method="post">
                            <h3 class="text-center text-info">Faculty Login</h3>
