...
<title>Update Details Of Faculty</title>
	      ...
	      <div class="row d-flex justify-content-center align-items-center h-100">
	        <div style="flex: 0 0 60%; max-width: 57%;" class="col-12 col-md-9 col-lg-7 col-xl-6">
	          <div class="card" style="border-radius: 15px; margin-top: 20px;">
				...
				<form action="/updatedFacultyProfile" method="post" style=" margin-top: -15px;">

		                <div class="form-outline mb-4">
		                  <input type="hidden" id="form3Example1cg" class="form-control form-control-lg" name="facultyid" path="studentid" value="${update.facultyid}" />
