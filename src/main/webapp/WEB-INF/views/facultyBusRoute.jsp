...
<html lang="en">
  <head>
    ...
    <title>Faculty Bus Route Page</title>
  </head>
  <body>
...
<div class="card shadow">
	...
	<div style="margin-top:15px; margin-left:422px; width:50%;heigth:10%;font-size: 19px;" class="alert-success text-center">
		<strong> ${msg}  </strong>
	</div>
		
			<h4 class="p-2" style="border-bottom:2px solid green;">Bus List</h4>
			...
			<table class="table table-bordered table-sm">
				...
				<tbody>
					<c:forEach var="b" items="${busRoute}">
						<tr>
							<td>${b.busno }</td>
							<td>${b.routeno }</td>
							<td>${b.drivername }</td>
							...
							<td>${b.destination }</td>
							<td>${b.feesamount }</td>
							<td><form action="facultyEnroll">      
	  								<div style="margin:auto;" class="btn btn-sm btn-primary">
		    							<button type="submit" name="enroll" >Click here to enroll</button>
									</div>
								</form></td>
						</tr>
					</c:forEach>
